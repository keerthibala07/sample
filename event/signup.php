    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form method="post" novalidate>
                ...
                <div class="error-message" id="nameError"><?php if(isset($errors['name'])) { echo $errors['name']; } ?></div>
                ...
                <div class="error-message" id="confirmPasswordError"><?php if(isset($errors['confirmPassword'])) { echo $errors['confirmPassword']; } ?></div>
                ...
                <div class="error-message" id="privacyPolicyError"><?php if(isset($errors['privacyPolicy'])) { echo $errors['privacyPolicy']; } ?></div>
